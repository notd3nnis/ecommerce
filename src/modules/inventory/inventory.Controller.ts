...
import {
    createProduct, getAllProducts, getProductById, editProduct, deleteProduct,
    createCategory, getAllCategories, getCategoryById, editCategory, deleteCategory,
} from "./inventory.service";

type CreateProductBody = Pick<IProduct, "name" | "description" | "price" | "category" | "stock" | "imageUrl" | "color">;
type CreateCategoryBody = Pick<ICategory, "name" | "description">;

export const createNewProduct = catchAsync(async (req: Request, res: Response, _next: NextFunction) => {
...
export const getAProduct = catchAsync(async (req: Request, res: Response, _next: NextFunction) => {
...
export const removeProduct = catchAsync(async (req: Request, res: Response, _next: NextFunction) => {
...
export const newCategory = catchAsync(async (req: Request, res: Response, _next: NextFunction) => {
...
export const getACategory = catchAsync(async (req: Request, res: Response, _next: NextFunction) => {
...
export const removeCategory = catchAsync(async (req: Request, res: Response, _next: NextFunction) => {
